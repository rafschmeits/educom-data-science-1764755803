...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 16 dec 2025 om 11:07
...
INSERT INTO `mhl_hitcount` (`year`, `COUNT(hitcount)`, `AVG(hitcount)`, `MIN(hitcount)`, `MAX(hitcount)`, `SUM(hitcount)`) VALUES
(2013, 38289, 1.6218, 1, 168, 62099),
(2014, 80713, 2.5114, 1, 882, 202702),
(2015, 84445, 2.5057, 1, 607, 211592),
(2016, 4205, 2.6171, 1, 60, 11005);
