...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 23 dec 2025 om 09:31
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `give_5_percent_raise` ()   BEGIN
    UPDATE employees
    SET salary = ROUND(salary * 1.05)
    WHERE date_fired IS NULL;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `p_customer_reporting` (IN `p_customerNumber` INT)   BEGIN
    ...
    -- Schrijf resultaat weg in reporting tabel
    INSERT INTO customer_reporting (customerNumber, customerName, totalOrderAmount)
    VALUES (p_customerNumber, v_customerName, v_totalAmount);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `p_get_customer_level` (IN `pCustomerNumber` INT, OUT `pCustomerLevel` VARCHAR(20))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `p_get_customer_shipping` (IN `pCustomerNUmber` INT, OUT `pShipping` VARCHAR(50))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `p_get_total_order_by_customer` (IN `p_customerNumber` INT)   BEGIN
    ...
    SELECT totalOrder AS total_orders;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `p_loop_demo` ()   BEGIN
    DECLARE x  INT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `p_while_demo` ()   BEGIN
    DECLARE x  INT;
    DECLARE str  VARCHAR(255);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `remove_fired_employees` ()   BEGIN
    /* 1. Archiveer ALLE ontslagen werknemers */
    ...
    SELECT
        ...
        NOW()
    FROM employees e
    LEFT JOIN employeeArchive ea
        ON ea.employeeNumber = e.employeeNumber
    WHERE e.date_fired IS NOT NULL
      AND ea.employeeNumber IS NULL;

    /* 2. FK-fixes */
    UPDATE employees
    SET reportsTo = NULL
    WHERE reportsTo IN (
        SELECT employeeNumber FROM employeeArchive
    );
    ...
    /* 3. Verwijder ontslagen werknemers */
...
-- Functies
--
CREATE DEFINER=`root`@`localhost` FUNCTION `employee_status_by_id` (`empId` INT) RETURNS VARCHAR(10) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DETERMINISTIC BEGIN
    DECLARE firedDate DATE;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `f_customer_level` (`credit` DECIMAL(10,2)) RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DETERMINISTIC BEGIN
...
(103, 'Atelier graphique', 'Schmitt', 'Carine ', '40.32.2555', '54, rue Royale', NULL, 'Nantes', NULL, '44000', 'France', NULL, 21000.00),
...
(124, 'Mini Gifts Distributors Ltd.', 'Nelson', 'Susan', '4155551450', '5677 Strong St.', NULL, 'San Rafael', 'CA', '97562', 'USA', NULL, 210500.00),
(125, 'Havel & Zbyszek Co', 'Piestrzeniewicz', 'Zbyszek ', '(26) 642-7555', 'ul. Filtrowa 68', NULL, 'Warszawa', NULL, '01-012', 'Poland', NULL, 0.00),
(128, 'Blauer See Auto, Co.', 'Keitel', 'Roland', '+49 69 66 90 2555', 'Lyonerstr. 34', NULL, 'Frankfurt', NULL, '60528', 'Germany', 1504, 59700.00),
(129, 'Mini Wheels Co.', 'Murphy', 'Julie', '6505555787', '5557 North Pendale Street', NULL, 'San Francisco', 'CA', '94217', 'USA', NULL, 64600.00),
...
(148, 'Dragon Souveniers, Ltd.', 'Natividad', 'Eric', '+65 221 7555', 'Bronz Sok.', 'Bronz Apt. 3/6 Tesvikiye', 'Singapore', NULL, '079903', 'Singapore', NULL, 103800.00),
...
(161, 'Technics Stores Inc.', 'Hashimoto', 'Juri', '6505556809', '9408 Furth Circle', NULL, 'Burlingame', 'CA', '94217', 'USA', NULL, 84600.00),
(166, 'Handji Gifts& Co', 'Victorino', 'Wendy', '+65 224 1555', '106 Linden Road Sandown', '2nd Floor', 'Singapore', NULL, '069045', 'Singapore', NULL, 97900.00),
...
(171, 'Daedalus Designs Imports', 'Rancé', 'Martine ', '20.16.1555', '184, chaussée de Tournai', NULL, 'Lille', NULL, '59000', 'France', NULL, 82900.00),
(172, 'La Corne D\'abondance, Co.', 'Bertrand', 'Marie', '(1) 42.34.2555', '265, boulevard Charonne', NULL, 'Paris', NULL, '75012', 'France', NULL, 84300.00),
(173, 'Cambridge Collectables Co.', 'Tseng', 'Jerry', '6175555555', '4658 Baden Av.', NULL, 'Cambridge', 'MA', '51247', 'USA', NULL, 43400.00),
(175, 'Gift Depot Inc.', 'King', 'Julie', '2035552570', '25593 South Bay Ln.', NULL, 'Bridgewater', 'CT', '97562', 'USA', 1323, 84300.00),
(177, 'Osaka Souveniers Co.', 'Kentary', 'Mory', '+81 06 6342 5555', '1-6-20 Dojima', NULL, 'Kita-ku', 'Osaka', ' 530-0003', 'Japan', NULL, 81200.00),
...
(204, 'Online Mini Collectables', 'Barajas', 'Miguel', '6175557555', '7635 Spinnaker Dr.', NULL, 'Brickhaven', 'MA', '58339', 'USA', NULL, 68700.00),
(205, 'Toys4GrownUps.com', 'Young', 'Julie', '6265557265', '78934 Hillside Dr.', NULL, 'Pasadena', 'CA', '90003', 'USA', NULL, 90700.00),
...
(209, 'Mini Caravy', 'Citeaux', 'Frédérique ', '88.60.1555', '24, place Kléber', NULL, 'Strasbourg', NULL, '67000', 'France', NULL, 53800.00),
(211, 'King Kong Collectables, Co.', 'Gao', 'Mike', '+852 2251 1555', 'Bank of China Tower', '1 Garden Road', 'Central Hong Kong', NULL, NULL, 'Hong Kong', NULL, 58600.00),
(216, 'Enaco Distributors', 'Saavedra', 'Eduardo ', '(93) 203 4555', 'Rambla de Cataluña, 23', NULL, 'Barcelona', NULL, '08022', 'Spain', NULL, 60300.00),
(219, 'Boards & Toys Co.', 'Young', 'Mary', '3105552373', '4097 Douglas Av.', NULL, 'Glendale', 'CA', '92561', 'USA', NULL, 11000.00),
...
(239, 'Collectable Mini Designs Co.', 'Thompson', 'Valarie', '7605558146', '361 Furth Circle', NULL, 'San Diego', 'CA', '91217', 'USA', NULL, 105000.00),
...
(242, 'Alpha Cognac', 'Roulet', 'Annette ', '61.77.6555', '1 rue Alsace-Lorraine', NULL, 'Toulouse', NULL, '31000', 'France', NULL, 61100.00),
...
(250, 'Lyon Souveniers', 'Da Silva', 'Daniel', '+33 1 46 62 7555', '27 rue du Colonel Pierre Avia', NULL, 'Paris', NULL, '75508', 'France', NULL, 68100.00),
(256, 'Auto Associés & Cie.', 'Tonini', 'Daniel ', '30.59.8555', '67, avenue de l\'Europe', NULL, 'Versailles', NULL, '78000', 'France', NULL, 77900.00),
...
(276, 'Anna\'s Decorations, Ltd', 'O\'Hara', 'Anna', '02 9936 8555', '201 Miller Street', 'Level 15', 'North Sydney', 'NSW', '2060', 'Australia', NULL, 107800.00),
(278, 'Rovelli Gifts', 'Rovelli', 'Giovanni ', '035-640555', 'Via Ludovico il Moro 22', NULL, 'Bergamo', NULL, '24100', 'Italy', 1401, 119600.00),
(282, 'Souveniers And Things Co.', 'Huxley', 'Adrian', '+61 2 9495 8555', 'Monitor Money Building', '815 Pacific Hwy', 'Chatswood', 'NSW', '2067', 'Australia', NULL, 93300.00),
...
(298, 'Vida Sport, Ltd', 'Holz', 'Mihael', '0897-034555', 'Grenzacherweg 237', NULL, 'Genève', NULL, '1203', 'Switzerland', NULL, 141300.00),
...
(320, 'Mini Creations Ltd.', 'Huang', 'Wing', '5085559555', '4575 Hillside Dr.', NULL, 'New Bedford', 'MA', '50553', 'USA', NULL, 94500.00),
(321, 'Corporate Gift Ideas Co.', 'Brown', 'Julie', '6505551386', '7734 Strong St.', NULL, 'San Francisco', 'CA', '94217', 'USA', NULL, 105000.00),
(323, 'Down Under Souveniers, Inc', 'Graham', 'Mike', '+64 9 312 5555', '162-164 Grafton Road', 'Level 2', 'Auckland  ', NULL, NULL, 'New Zealand', NULL, 88000.00),
...
(333, 'Australian Gift Network, Co', 'Calaghan', 'Ben', '61-7-3844-6555', '31 Duncan St. West End', NULL, 'South Brisbane', 'Queensland', '4101', 'Australia', NULL, 51600.00),
...
(339, 'Classic Gift Ideas, Inc', 'Cervantes', 'Francisca', '2155554695', '782 First Street', NULL, 'Philadelphia', 'PA', '71270', 'USA', NULL, 81100.00),
(344, 'CAF Imports', 'Fernandez', 'Jesus', '+34 913 728 555', 'Merchants House', '27-30 Merchant\'s Quay', 'Madrid', NULL, '28023', 'Spain', NULL, 59600.00),
(347, 'Men \'R\' US Retailers, Ltd.', 'Chandler', 'Brian', '2155554369', '6047 Douglas Av.', NULL, 'Los Angeles', 'CA', '91003', 'USA', NULL, 57700.00),
(348, 'Asian Treasures, Inc.', 'McKenna', 'Patricia ', '2967 555', '8 Johnstown Road', NULL, 'Cork', 'Co. Cork', NULL, 'Ireland', NULL, 0.00),
(350, 'Marseille Mini Autos', 'Lebihan', 'Laurence ', '91.24.4555', '12, rue des Bouchers', NULL, 'Marseille', NULL, '13008', 'France', NULL, 65000.00),
(353, 'Reims Collectables', 'Henriot', 'Paul ', '26.47.1555', '59 rue de l\'Abbaye', NULL, 'Reims', NULL, '51100', 'France', NULL, 81100.00),
...
(357, 'GiftsForHim.com', 'MacKinlay', 'Wales', '64-9-3763555', '199 Great North Road', NULL, 'Auckland', NULL, NULL, 'New Zealand', NULL, 77700.00),
...
(376, 'Precious Collectables', 'Urs', 'Braun', '0452-076555', 'Hauptstr. 29', NULL, 'Bern', NULL, '3012', 'Switzerland', NULL, 0.00),
(379, 'Collectables For Less Inc.', 'Nelson', 'Allen', '6175558555', '7825 Douglas Av.', NULL, 'Brickhaven', 'MA', '58339', 'USA', NULL, 70700.00),
...
(385, 'Cruz & Sons Co.', 'Cruz', 'Arnold', '+63 2 555 3587', '15 McCallum Street', 'NatWest Center #13-03', 'Makati City', NULL, '1227 MM', 'Philippines', NULL, 81500.00),
...
(398, 'Tokyo Collectables, Ltd', 'Shimamura', 'Akiko', '+81 3 3584 0555', '2-2-8 Roppongi', NULL, 'Minato-ku', 'Tokyo', '106-0032', 'Japan', NULL, 94400.00),
(406, 'Auto Canal+ Petit', 'Perrier', 'Dominique', '(1) 47.55.6555', '25, rue Lauriston', NULL, 'Paris', NULL, '75016', 'France', NULL, 95000.00),
(409, 'Stuttgart Collectable Exchange', 'Müller', 'Rita ', '0711-555361', 'Adenauerallee 900', NULL, 'Stuttgart', NULL, '70563', 'Germany', NULL, 0.00),
(412, 'Extreme Desk Decorations, Ltd', 'McRoy', 'Sarah', '04 499 9555', '101 Lambton Quay', 'Level 11', 'Wellington', NULL, NULL, 'New Zealand', NULL, 86800.00),
...
(450, 'The Sharp Gifts Warehouse', 'Frick', 'Sue', '4085553659', '3086 Ingle Ln.', NULL, 'San Jose', 'CA', '94217', 'USA', NULL, 77600.00),
...
(458, 'Corrida Auto Replicas, Ltd', 'Sommer', 'Martín ', '(91) 555 22 82', 'C/ Araquil, 67', NULL, 'Madrid', NULL, '28023', 'Spain', NULL, 104600.00),
...
(471, 'Australian Collectables, Ltd', 'Clenahan', 'Sean', '61-9-3844-6555', '7 Allen Street', NULL, 'Glen Waverly', 'Victoria', '3150', 'Australia', NULL, 60300.00),
...
(475, 'West Coast Collectables Co.', 'Thompson', 'Steve', '3105553722', '3675 Furth Circle', NULL, 'Burbank', 'CA', '94019', 'USA', NULL, 55400.00),
...
(484, 'Iberia Gift Imports, Corp.', 'Roel', 'José Pedro ', '(95) 555 82 82', 'C/ Romero, 33', NULL, 'Sevilla', NULL, '41101', 'Spain', NULL, 65700.00),
(486, 'Motor Mint Distributors Inc.', 'Salazar', 'Rosa', '2155559857', '11328 Douglas Av.', NULL, 'Philadelphia', 'PA', '71270', 'USA', 1323, 72600.00),
(487, 'Signal Collectibles Ltd.', 'Taylor', 'Sue', '4155554312', '2793 Furth Circle', NULL, 'Brisbane', 'CA', '94217', 'USA', NULL, 60300.00),
(489, 'Double Decker Gift Stores, Ltd', 'Smith', 'Thomas ', '(171) 555-7555', '120 Hanover Sq.', NULL, 'London', NULL, 'WA1 1DP', 'UK', 1501, 43300.00),
(495, 'Diecast Collectables', 'Franco', 'Valarie', '6175552555', '6251 Ingle Ln.', NULL, 'Boston', 'MA', '51003', 'USA', NULL, 85100.00),
(496, 'Kelly\'s Gift Shop', 'Snowden', 'Tony', '+64 9 5555500', 'Arenales 1938 3\'A\'', NULL, 'Auckland  ', NULL, NULL, 'New Zealand', NULL, 110000.00);
...
--
-- Tabelstructuur voor tabel `employeearchive`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `employeearchive`
--

INSERT INTO `employeearchive` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`, `salary`, `date_hired`, `date_fired`, `archived_at`) VALUES
(1088, 'Patterson', 'William', 'x4871', 'wpatterson@classicmodelcars.com', '6', 1056, 'Sales Manager (APAC)', 15000, '2006-12-02', '2025-12-12', '2025-12-22 13:28:47'),
(1621, 'Nishi', 'Mami', 'x101', 'mnishi@classicmodelcars.com', '5', NULL, 'Sales Rep', 3087, '2025-12-08', '0000-00-00', '2025-12-23 08:18:15');
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`, `salary`, `date_hired`, `date_fired`) VALUES
(1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', NULL, 'President', 15750, '2009-12-02', NULL),
(1143, 'Bow', 'Anthony', 'x5428', 'abow@classicmodelcars.com', '1', NULL, 'Sales Manager (NA)', 6946, '2005-02-02', NULL),
(1216, 'Patterson', 'Steve', 'x4334', 'spatterson@classicmodelcars.com', '2', 1143, 'Sales Rep', 10998, '2010-04-28', NULL),
(1286, 'Tseng', 'Foon Yue', 'x2248', 'ftseng@classicmodelcars.com', '3', 1143, 'Sales Rep', 10998, '2015-01-19', NULL),
(1323, 'Vanauf', 'George', 'x4102', 'gvanauf@classicmodelcars.com', '3', 1143, 'Sales Rep', 9647, '2022-05-16', NULL),
(1401, 'Castillo', 'Pamela', 'x2759', 'pcastillo@classicmodelcars.com', '4', NULL, 'Sales Rep', 4667, '2020-03-05', NULL),
(1501, 'Bott', 'Larry', 'x2311', 'lbott@classicmodelcars.com', '7', NULL, 'Sales Rep', 6136, '2001-11-11', NULL),
(1504, 'Jones', 'Barry', 'x102', 'bjones@classicmodelcars.com', '7', NULL, 'Sales Rep', 14506, '2005-05-08', NULL),
(1619, 'King', 'Tom', 'x103', 'tking@classicmodelcars.com', '6', NULL, 'Sales Rep', 3859, '2023-08-08', NULL);

--
-- Triggers `employees`
--
DELIMITER $$
CREATE TRIGGER `trg_employee_fired` AFTER UPDATE ON `employees` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_salary_update` BEFORE UPDATE ON `employees` FOR EACH ROW BEGIN
...
--
-- Stand-in structuur voor view `employee_status_view`
...
--
DELIMITER $$
CREATE TRIGGER `members_air` AFTER INSERT ON `members` FOR EACH ROW BEGIN
...
--
-- Gegevens worden geëxporteerd voor tabel `reminders`
--
...
--
-- Tabelstructuur voor tabel `salaryarchive`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `salaryarchive`
--

INSERT INTO `salaryarchive` (`archive_id`, `employeeNumber`, `old_salary`, `new_salary`, `changed_at`) VALUES
(1, 1002, 5000, 15000, '2025-12-23 08:29:12'),
(2, 1002, 15000, 15750, '2025-12-23 08:30:15'),
(3, 1143, 6615, 6946, '2025-12-23 08:30:15'),
(4, 1216, 10474, 10998, '2025-12-23 08:30:15'),
(5, 1286, 10474, 10998, '2025-12-23 08:30:15'),
(6, 1323, 9188, 9647, '2025-12-23 08:30:15'),
(7, 1401, 4445, 4667, '2025-12-23 08:30:15'),
(8, 1501, 5844, 6136, '2025-12-23 08:30:15'),
(9, 1504, 13815, 14506, '2025-12-23 08:30:15'),
(10, 1619, 3675, 3859, '2025-12-23 08:30:15');

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `salarybudgets`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `salarybudgets`
--
...
--
DELIMITER $$
CREATE TRIGGER `sales_aur` AFTER UPDATE ON `sales` FOR EACH ROW BEGIN
...
--
-- Tabelstructuur voor tabel `workcenters`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `workcenters`
--
...
--
DELIMITER $$
CREATE TRIGGER `workcenters_bir` BEFORE INSERT ON `workcenters` FOR EACH ROW BEGIN
...
--
-- Tabelstructuur voor tabel `workcenterstats`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `workcenterstats`
--
...
--
-- Structuur voor de view `employee_status_view`
--
DROP TABLE IF EXISTS `employee_status_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `employee_status_view`  AS SELECT `employees`.`employeeNumber` AS `employeeNumber`, `employees`.`firstName` AS `firstName`, `employees`.`lastName` AS `lastName`, `employee_status_by_id`(`employees`.`employeeNumber`) AS `status` FROM `employees` ;
...
--
-- Indexen voor tabel `employeearchive`
--
...
--
-- Indexen voor tabel `reminders`
--
ALTER TABLE `reminders`
  ADD PRIMARY KEY (`id`,`memberId`);

--
-- Indexen voor tabel `salaryarchive`
--
ALTER TABLE `salaryarchive`
...
--
-- Indexen voor tabel `workcenters`
--
...
--
-- AUTO_INCREMENT voor een tabel `reminders`
--
ALTER TABLE `reminders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT voor een tabel `salaryarchive`
--
ALTER TABLE `salaryarchive`
...
--
-- AUTO_INCREMENT voor een tabel `workcenters`
--
ALTER TABLE `workcenters`
